...
public class CJH_RoundedImageView extends androidx.appcompat.widget.AppCompatImageView {
    ...
    public CJH_RoundedImageView(Context context, AttributeSet attrs, int defStyle) {
