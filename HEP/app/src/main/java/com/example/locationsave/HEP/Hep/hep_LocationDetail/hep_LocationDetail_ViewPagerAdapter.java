...
public class hep_LocationDetail_ViewPagerAdapter extends PagerAdapter {
    private Context mContext;

    public hep_LocationDetail_ViewPagerAdapter(Context context) {
    ...
    public Object instantiateItem(final ViewGroup container, final int position) {
        ...
        ViewGroup layout = (ViewGroup) inflater.inflate(R.layout.hep_locationdetail_viewpageritem, container, false);

        PhotoView photoView = layout.findViewById(R.id.locationdetailviewpager_image);
        ...
        photoView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra ("CurrentItem", ((hep_LocationDetailActivity)mContext).viewPager.getCurrentItem());
