...
public class hep_LocationSave_ViewPagerAdapter extends PagerAdapter {
    ...
    public hep_LocationSave_ViewPagerAdapter(Context context) {
    ...
    public Object instantiateItem(final ViewGroup container, final int position) {
        ...
        photoView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra ("CurrentItem", ((hep_LocationSaveActivity)mContext).viewPager.getCurrentItem());
        ...
        btnCloseLocationImage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ((hep_LocationSaveActivity)mContext).removeCurrentItem();
            }
        });
