...
public class hep_LocationUpdate_FlowLayoutImageItem extends RelativeLayout {
    ...
    public hep_LocationUpdate_FlowLayoutImageItem(Context context) {
        super(context);
        mContext = context;
        setLayout();
        setInit();
    ...
    public hep_LocationUpdate_FlowLayoutImageItem(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
